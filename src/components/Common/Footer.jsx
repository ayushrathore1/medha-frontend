        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <img 
                ...
                className="w-8 h-8" 
              />
              <span className="text-xl font-bold text-blue-400">MEDHA</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Boost your learning with AI-powered note upload, instant flashcards, 
              smart quizzes, and a personalized chatbot. Organized. Efficient. Fun.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/flashcards" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Flashcards
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/chatbot" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Chatbot
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/feedback" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Feedback
                </Link>
              </li>
              <li>
